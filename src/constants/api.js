...
// home
export const API_HOME = `${host}/xhr/index.json`
...
// cate
export const API_CATE = `${host}/item/cateList.json`
...
export const API_CART_ADD = `${host}/xhr/cart/add.json`
...
export const API_USER_LOGIN = `${hostM}/dl/gt`
